            ...
            <div class= "card-group">
              ...
              <div class= "card">
               <div class= "card-body border border-primary mr-1">
                ...
                <p class= "card-tex text-center"><small class="text-muted">* Presentar documentación</small></p>
               </div>
              </div>
              <div class= "card">
               <div class= "card-body border border-primary mr-1">
            ...
            <form>
                ...
                <div class="form-row  ">
                  <div class ="form-group col mt-3">
                    <div id="totalCompra" class="alert alert-primary mt-6" role="alert">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary " data-bs-dismiss="modal"  style="background-color: #89c42a;>Cancelar</button>
            <button type="button"  onclick= "confirma()" class="btn btn-primary "  style="background-color: #89c42a;>Confirmar la Compra</button>
          </div>
        </div>
      </div>
    </div>
